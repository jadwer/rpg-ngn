...
const styles = StyleSheet.create({
  ...
  memberText: { flex: 1, fontFamily: theme.fonts.ui, fontSize: 15, color: theme.colors.ink },
  row: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  rowText: { flex: 1, fontFamily: theme.fonts.ui, fontSize: 14, color: theme.colors.ink },
  input: { flex: 1, fontFamily: theme.fonts.ui, fontSize: 15, color: theme.colors.ink, backgroundColor: theme.colors.panel, borderWidth: 1, borderColor: theme.colors.borderSoft, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 8 },
  ...
  chipText: { fontFamily: theme.fonts.ui, fontSize: 13, color: theme.colors.ink },
  ...
  found: { backgroundColor: theme.colors.panel, borderWidth: 1, borderColor: theme.colors.borderSoft, borderRadius: theme.radius, padding: 12, gap: 6 },
