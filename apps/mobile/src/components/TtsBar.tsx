...
const styles = StyleSheet.create({
  ...
  summaryText: { flexShrink: 1, fontFamily: theme.fonts.ui, fontSize: 13, color: theme.colors.inkDim, textAlign: 'right' },
  ...
  rate: { fontFamily: theme.fonts.uiSemiBold, fontSize: 12, color: theme.colors.inkDim },
  switchRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 8 },
  switchLabel: { flex: 1, fontFamily: theme.fonts.ui, fontSize: 14, color: theme.colors.inkDim },
  narrating: { flex: 1, fontFamily: theme.fonts.ui, fontSize: 14, color: theme.colors.accentBright },
  noticeRow: { gap: 4 },
  notice: { fontFamily: theme.fonts.ui, fontSize: 13, lineHeight: 18, color: theme.colors.inkDim },
  link: { fontFamily: theme.fonts.ui, fontSize: 13, color: theme.colors.nebula, textDecorationLine: 'underline' },
  button: { borderWidth: 1, borderColor: theme.colors.border, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 5, backgroundColor: theme.colors.panel, minHeight: 30, justifyContent: 'center' },
  primary: { backgroundColor: theme.colors.accent, borderColor: theme.colors.accent },
  disabled: { opacity: 0.45 },
  pressed: { opacity: 0.7 },
  buttonText: { fontFamily: theme.fonts.uiSemiBold, fontSize: 13, color: theme.colors.ink, letterSpacing: 0.2 },
