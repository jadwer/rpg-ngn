...
const styles = StyleSheet.create({
  ...
  who: { flex: 1 },
  name: { fontFamily: theme.fonts.serifSemiBold, fontSize: 26, color: theme.colors.ink, letterSpacing: 0.2 },
  sub: { fontFamily: theme.fonts.ui, fontSize: 15, color: theme.colors.inkDim, marginTop: 2 },
  quote: { fontFamily: theme.fonts.serifItalic, fontSize: 16, color: theme.colors.ink, borderLeftWidth: 3, borderLeftColor: theme.colors.accentBright, paddingLeft: 10, marginVertical: 10 },
  veil: { fontFamily: theme.fonts.ui, fontSize: 14, color: theme.colors.inkDim, backgroundColor: theme.colors.panel2, borderRadius: 8, padding: 10, marginVertical: 8 },
  vitals: { flexDirection: 'row', gap: 8, marginVertical: 8 },
  vital: { flex: 1, alignItems: 'center', backgroundColor: theme.colors.panel2, borderWidth: 1, borderColor: theme.colors.borderSoft, borderRadius: 8, paddingVertical: 8 },
  vitalValue: { fontFamily: theme.fonts.uiSemiBold, fontSize: 20, color: theme.colors.ink },
  vitalLabel: { fontFamily: theme.fonts.uiMedium, fontSize: 11, color: theme.colors.inkDim, letterSpacing: 0.2 },
  stats: { flexDirection: 'row', gap: 4, marginBottom: 6 },
  stat: { flex: 1, alignItems: 'center', backgroundColor: theme.colors.panel2, borderWidth: 1, borderColor: theme.colors.borderSoft, borderRadius: 8, paddingVertical: 6 },
  statLabel: { fontFamily: theme.fonts.ui, fontSize: 10, color: theme.colors.inkDim, letterSpacing: 0.2 },
  statValue: { fontFamily: theme.fonts.uiSemiBold, fontSize: 17, color: theme.colors.ink },
  statMod: { fontFamily: theme.fonts.ui, fontSize: 12, color: theme.colors.gold },
  label: { fontFamily: theme.fonts.uiMedium, fontSize: 12, letterSpacing: 0.2, color: theme.colors.inkDim, marginTop: 14, marginBottom: 4 },
  kit: { gap: 6 },
  item: { backgroundColor: theme.colors.panel2, borderWidth: 1, borderColor: theme.colors.borderSoft, borderRadius: 8, padding: 9, gap: 4 },
  itemTop: { flexDirection: 'row', alignItems: 'baseline', gap: 8, flexWrap: 'wrap' },
  itemName: { fontFamily: theme.fonts.uiSemiBold, fontSize: 16, color: theme.colors.ink },
  damage: { fontFamily: theme.fonts.uiSemiBold, fontSize: 13, color: theme.colors.goldBright, borderWidth: 1, borderColor: theme.colors.goldDim, borderRadius: 4, paddingHorizontal: 5 },
  ...
  chip: { fontFamily: theme.fonts.ui, fontSize: 14, color: theme.colors.ink, backgroundColor: theme.colors.panel2, borderWidth: 1, borderColor: theme.colors.borderSoft, borderRadius: 999, paddingHorizontal: 11, paddingVertical: 3 },
  chipAccent: { borderColor: theme.colors.accentBright, color: theme.colors.danger },
  roles: { fontFamily: theme.fonts.ui, fontSize: 15, color: theme.colors.inkDim },
  inventory: { fontFamily: theme.fonts.ui, fontSize: 15, color: theme.colors.ink, marginBottom: 2 },
  body: { fontFamily: theme.fonts.ui, fontSize: 16, lineHeight: 23, color: theme.colors.ink },
})
