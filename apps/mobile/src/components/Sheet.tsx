...
const styles = StyleSheet.create({
  ...
  who: { flex: 1 },
  name: { fontFamily: theme.fonts.display, fontSize: 26, color: theme.colors.ink, letterSpacing: 1 },
  ...
  veil: { fontFamily: theme.fonts.serifItalic, fontSize: 14, color: theme.colors.inkDim, backgroundColor: theme.colors.panel2, borderRadius: 8, padding: 10, marginVertical: 8 },
  ...
  statValue: { fontFamily: theme.fonts.displayBold, fontSize: 17, color: theme.colors.ink },
  statMod: { fontFamily: theme.fonts.serif, fontSize: 12, color: theme.colors.gold },
  label: { fontFamily: theme.fonts.display, fontSize: 12, letterSpacing: 1.5, textTransform: 'uppercase', color: theme.colors.inkDim, marginTop: 14, marginBottom: 4 },
  kit: { gap: 6 },
  ...
  itemName: { fontFamily: theme.fonts.serifSemiBold, fontSize: 16, color: theme.colors.ink },
  damage: { fontFamily: theme.fonts.display, fontSize: 13, color: theme.colors.goldBright, borderWidth: 1, borderColor: theme.colors.goldDim, borderRadius: 4, paddingHorizontal: 5 },
  ...
  chip: { fontFamily: theme.fonts.serif, fontSize: 14, color: theme.colors.ink, backgroundColor: theme.colors.panel2, borderWidth: 1, borderColor: theme.colors.borderSoft, borderRadius: 999, paddingHorizontal: 11, paddingVertical: 3 },
