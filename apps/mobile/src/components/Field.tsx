...
const styles = StyleSheet.create({
  ...
  input: { fontFamily: theme.fonts.serif, fontSize: 16, color: theme.colors.ink, backgroundColor: theme.colors.panel, borderWidth: 1, borderColor: theme.colors.borderSoft, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 10 },
