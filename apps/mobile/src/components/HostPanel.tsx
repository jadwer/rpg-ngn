...
const styles = StyleSheet.create({
  ...
  premise: { fontFamily: theme.fonts.ui, fontSize: 13, lineHeight: 18, color: theme.colors.inkDim },
  ...
  modalTitle: { fontFamily: theme.fonts.serifSemiBold, fontSize: 18, color: theme.colors.ink, letterSpacing: 0.2 },
  modalLink: { fontFamily: theme.fonts.ui, fontSize: 16, color: theme.colors.nebula },
