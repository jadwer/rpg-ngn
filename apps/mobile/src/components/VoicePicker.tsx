...
const styles = StyleSheet.create({
  ...
  warn: { fontFamily: theme.fonts.ui, fontSize: 14, lineHeight: 19, color: theme.colors.goldBright, backgroundColor: theme.colors.warning, borderWidth: 1, borderColor: theme.colors.border, borderRadius: 8, padding: 10 },
  ...
  chipText: { fontFamily: theme.fonts.ui, fontSize: 14, color: theme.colors.inkDim },
  ...
  rowLabel: { fontFamily: theme.fonts.ui, fontSize: 15, color: theme.colors.ink },
  rowLabelOn: { color: '#ffffff' },
  rowSub: { fontFamily: theme.fonts.ui, fontSize: 12, color: theme.colors.inkDim },
  stepper: { flexDirection: 'row', alignItems: 'center', gap: 12, alignSelf: 'flex-start' },
  stepperValue: { fontFamily: theme.fonts.uiSemiBold, fontSize: 16, color: theme.colors.ink, minWidth: 56, textAlign: 'center' },
