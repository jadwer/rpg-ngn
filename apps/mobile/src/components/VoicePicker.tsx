...
const styles = StyleSheet.create({
  ...
  headerLink: { fontFamily: theme.fonts.serif, fontSize: 16, color: theme.colors.cyan },
  ...
  label: { fontFamily: theme.fonts.display, fontSize: 12, letterSpacing: 1.5, textTransform: 'uppercase', color: theme.colors.inkDim, marginTop: 14 },
