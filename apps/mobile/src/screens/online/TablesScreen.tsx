...
const styles = StyleSheet.create({
  ...
  role: { fontFamily: theme.fonts.ui, fontSize: 15, color: theme.colors.ink },
  meta: { fontFamily: theme.fonts.ui, fontSize: 13, color: theme.colors.inkDim },
  party: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginTop: 4 },
  member: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  memberText: { fontFamily: theme.fonts.ui, fontSize: 13, color: theme.colors.inkDim },
  warn: { fontFamily: theme.fonts.ui, fontSize: 13, color: theme.colors.danger },
  friends: { marginTop: 14 },
  archivadas: { marginTop: 10, gap: 10 },
  archivadasTitulo: { fontFamily: theme.fonts.uiSemiBold, fontSize: 13, color: theme.colors.ink, letterSpacing: 0.2 },
