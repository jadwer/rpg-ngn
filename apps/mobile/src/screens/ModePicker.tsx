...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: theme.fonts.display, fontSize: 34, color: theme.colors.gold, textAlign: 'center', letterSpacing: 3, textTransform: 'uppercase' },
  ...
  cardPrimary: { borderColor: theme.colors.gold, backgroundColor: theme.colors.panel2 },
  pressed: { opacity: 0.8 },
  cardTitle: { fontFamily: theme.fonts.display, fontSize: 19, color: theme.colors.gold, letterSpacing: 0.5 },
  cardTitlePrimary: { color: theme.colors.goldBright },
