...
const styles = StyleSheet.create({
  ...
  backText: { fontFamily: theme.fonts.ui, fontSize: 16, color: theme.colors.nebula },
  motto: { fontFamily: theme.fonts.ui, color: theme.colors.inkDim, textAlign: 'center', fontSize: 15 },
  title: { fontFamily: theme.fonts.uiMedium, fontSize: 30, color: theme.colors.ink, textAlign: 'center', letterSpacing: 0.2 },
  tagline: { fontFamily: theme.fonts.uiMedium, color: theme.colors.inkDim, textAlign: 'center', letterSpacing: 0.2, marginBottom: 8, fontSize: 12 },
  hint: { fontFamily: theme.fonts.ui, color: theme.colors.inkDim, fontSize: 14, marginTop: 6 },
  ...
  cardTitle: { flex: 1, fontFamily: theme.fonts.serifSemiBold, fontSize: 17, color: theme.colors.ink },
  badge: { fontFamily: theme.fonts.uiMedium, fontSize: 11, letterSpacing: 0.2, color: theme.colors.inkDim, borderWidth: 1, borderColor: theme.colors.border, borderRadius: 999, paddingHorizontal: 8, paddingVertical: 1 },
  badgeNext: { color: '#ffffff', borderColor: theme.colors.accentBright },
  date: { fontFamily: theme.fonts.ui, fontSize: 13, color: theme.colors.inkDim },
  briefing: { fontFamily: theme.fonts.ui, fontSize: 15, lineHeight: 21, color: theme.colors.ink },
  party: { fontFamily: theme.fonts.ui, fontSize: 13, color: theme.colors.inkDim, marginTop: 4 },
  footer: { fontFamily: theme.fonts.ui, fontSize: 12, color: theme.colors.inkDim, textAlign: 'center', marginTop: 16, letterSpacing: 0.2 },
})
