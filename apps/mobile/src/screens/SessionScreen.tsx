...
const styles = StyleSheet.create({
  ...
  title: { flex: 1, fontFamily: theme.fonts.serifSemiBold, fontSize: 15, color: theme.colors.ink, textAlign: 'center' },
  sheetsButton: { borderWidth: 1, borderColor: theme.colors.border, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4 },
  sheetsText: { fontFamily: theme.fonts.uiSemiBold, fontSize: 13, color: theme.colors.ink },
