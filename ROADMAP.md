...
- [ ] **Borrar o archivar una mesa desde el producto.** Hoy **no existe**: solo `php artisan tables:prune`, que es un comando de servidor. Lo señalo Gabino el 22-09, y desde que los legales estan publicados es una **promesa incumplida** (el aviso reconoce el derecho de cancelacion). Archivar no es borrar: la mesa archivada deja de verse pero el registro sigue, que es la disociacion que describe el aviso
- [ ] **Guardar la aceptacion de los legales**: hoy el aviso se muestra al registrarse pero no se registra quien acepto, cuando y que version. Es una columna y un dato al registrar
- [ ] **Buzon `privacidad@gabinoramirez.com`**, publicado en los dos documentos legales y que **todavia no existe**
