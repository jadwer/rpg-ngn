...
- [ ] **Paridad movil de lo demas del 22-09**: retirar una mesa (archivar, borrar, salir) y borrar la cuenta existen solo en la web. El aviso legal del registro si esta en las dos
- [ ] **Retratos de los nueve NPC sin cara** (3 del piloto, 6 de la boticaria): prompts listos en `docs/20` con el enfoque de GPT (bloque maestro por pack + bloque por personaje, una imagen por NPC sin marco). Los genera Gabino
