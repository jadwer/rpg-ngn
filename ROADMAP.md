...
- [ ] Guardar los hallazgos del lint en el turno (columna `lint` en `turns`) para poder revisarlos despues de la partida; hoy solo viven en `result.lint` del engine y en el bloque del momento
